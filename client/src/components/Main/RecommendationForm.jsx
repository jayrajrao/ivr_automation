...
const RecommendationForm = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 my-10 bg-white shadow-lg rounded-md">
      <div className="text-2xl font-bold mb-4">Letter of Recommendation</div>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <button type="submit" className="w-full bg-indigo-600 text-white py-2 px-4 rounded-md shadow-sm hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
